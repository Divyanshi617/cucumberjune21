...
public class DemoWindow {
  ...
  public void f() {
	 ...
	 for(String singleW:allWindows)
	 {
		 driver.switchTo().window(singleW);
	 }
	 WebElement mainpage=driver.findElement(By.name("main_page"));
	 driver.switchTo().frame(mainpage);
	 WebElement contactus=driver.findElement(By.tagName("address"));
